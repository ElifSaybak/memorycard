...
export const CardView = observer(
    ({ card, cardSize, gapSize }: CardViewProps) => {
        ...
        if (card.isMatched) { // kart eşleşmiş ise
            runMatchAnimation.value = true // runMatchAnimation değeri true olur. matchAnimationStyle tetikler
        }
        ...
        //  kart eşleşmeme durumu(true) runNoMatchAnimation değerine atanır. noMatchAnimationStyle tetikler.
